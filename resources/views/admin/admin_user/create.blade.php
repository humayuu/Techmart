    ...
    <div class="card shadow-sm border-0 rounded-3">
        ...
        <div class="card-header bg-dark text-white px-4 py-3 rounded-top-3">
            <div class="d-flex align-items-center gap-2">
                ...
                <h6 class="mb-0 fw-semibold">Create Admin User</h6>
            </div>
        </div>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select id="role" name="role"
                                    ...
                                    <option value="normal_user" {{ old('role') == 'normal_user' ? 'selected' : '' }}>Normal
                                        User</option>
                                </select>
                                @error('role')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="file" id="image_upload_input" name="profile_image" accept="image/*"
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6 col-6">
                                    <div class="border rounded-2 px-3 py-2 d-flex align-items-center gap-2 bg-white">
                                        <input class="form-check-input access-checkbox mt-0 flex-shrink-0" type="checkbox"
                                            name="access[]" value="{{ $module['key'] }}"
                                            id="access_{{ $module['key'] }}"
                                            {{ in_array($module['key'], old('access', [])) ? 'checked' : '' }}>
