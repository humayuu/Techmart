...
<p style="font-size:13px;color:#777;margin:0 0 30px;line-height:1.7;">Your order has been placed successfully.
Here's a summary of what you ordered.</p>

<table style="width:100%;border-collapse:collapse;margin-bottom:30px;">
<tr>
<td style="padding:9px 0;font-size:12px;color:#999;border-bottom:1px solid #f0f0f0;width:40%;">Order ID
</td>
<td style="padding:9px 0;font-size:13px;color:#111;border-bottom:1px solid #f0f0f0;font-weight:600;">
#{{ $order->id }}</td>
</tr>
<tr>
<td style="padding:9px 0;font-size:12px;color:#999;border-bottom:1px solid #f0f0f0;">Date</td>
<td style="padding:9px 0;font-size:13px;color:#111;border-bottom:1px solid #f0f0f0;">
...
<span
style="background:#f0fdf4;color:#16a34a;padding:2px 10px;border-radius:3px;font-weight:600;">Paid</span>
@else
<span
style="background:#fefce8;color:#ca8a04;padding:2px 10px;border-radius:3px;font-weight:600;">Pending</span>
@endif
</td>
</tr>
</table>
...
<td style="padding:10px 0;font-size:13px;color:#111;text-align:right;">Rs.
...
<td style="padding:6px 0;font-size:12px;color:#777;text-align:right;">Rs.
{{ number_format($order->subtotal, 2) }}</td>
</tr>
<tr>
<td style="padding:6px 0;font-size:12px;color:#999;">Shipping ({{ ucfirst($order->shipping_method) }})
</td>
<td style="padding:6px 0;font-size:12px;color:#777;text-align:right;">Rs.
...
<tr>
<td style="padding:6px 0;font-size:12px;color:#16a34a;">
Discount
@if ($order->coupon_code)
<span
style="font-size:11px;background:#f0fdf4;padding:1px 7px;border-radius:3px;margin-left:5px;">
{{ $order->coupon_code }}
</span>
@endif
</td>
<td style="padding:6px 0;font-size:12px;color:#16a34a;text-align:right;">
...
<td style="padding:10px 0 0;font-size:14px;color:#111;font-weight:700;text-align:right;">Rs.
...
<p style="font-size:11px;color:#bbb;margin:0;">© {{ date('Y') }} TechMart &nbsp;·&nbsp; All rights reserved
</p>
</div>
